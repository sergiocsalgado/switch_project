...
import TableHeaderUS from "./TableHeaderUS";
import TableBodyUS from "./TableBodyUS";
    ...
    if (data.length > 0) {
        return (
            <div>
                ...
                <table border="1">
                    <TableHeaderUS/>
                    <TableBodyUS data={tableData} projectCode={projectCode}/>
                </table>
            </div>
        );
    }
